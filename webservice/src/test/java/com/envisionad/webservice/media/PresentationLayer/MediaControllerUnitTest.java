...
class MediaControllerUnitTest {
        ...
        void getAllFilteredActiveMedia_NoFilters_ShouldReturnList() {
                ...
                ResponseEntity<?> response = mediaController.getAllFilteredActiveMedia(null, null, null, null);
        ...
        void getAllFilteredActiveMedia_TitleOnly_ShouldReturnFiltered() {
                ...
                ResponseEntity<?> response = mediaController.getAllFilteredActiveMedia("Test", null, null, null);
        ...
        void getAllFilteredActiveMedia_MinPriceNegative_ShouldReturnBadRequest() {
                ResponseEntity<?> response = mediaController.getAllFilteredActiveMedia(null, BigDecimal.valueOf(-1),
                                null, null);
        ...
        void getAllFilteredActiveMedia_MaxPriceNegative_ShouldReturnBadRequest() {
                ResponseEntity<?> response = mediaController.getAllFilteredActiveMedia(null, null,
        ...
        void getAllFilteredActiveMedia_MinDailyImpressionsNegative_ShouldReturnBadRequest() {
                ResponseEntity<?> response = mediaController.getAllFilteredActiveMedia(null, null, null, -10);
        ...
        @Test
        void updateMedia_InvalidInput_ShouldReturnBadRequest() {
                doThrow(new IllegalArgumentException("Title cannot be empty"))
                                .when(validator).validate(any(MediaRequestModel.class));

                // Use a wrapper that throws the exception that the controller throws
                org.springframework.web.server.ResponseStatusException exception = assertThrows(
                                org.springframework.web.server.ResponseStatusException.class,
                                () -> mediaController.updateMedia(mediaId, requestModel));

                assertEquals(HttpStatus.BAD_REQUEST, exception.getStatusCode());
                assertEquals("Title cannot be empty", exception.getReason());

                verify(validator, times(1)).validate(any(MediaRequestModel.class));
                verifyNoInteractions(requestMapper, mediaService, responseMapper);
        }

        @Test
        void updateMedia_DigitalMissingLoopDuration_ShouldReturnBadRequest() {
                doThrow(new IllegalArgumentException("Loop Duration is required for Digital displays"))
                                .when(validator).validate(any(MediaRequestModel.class));
                ...
                assertEquals(HttpStatus.BAD_REQUEST, exception.getStatusCode());
                assertEquals("Loop Duration is required for Digital displays", exception.getReason());
        }

        @Test
        void updateMedia_PosterMissingDimensions_ShouldReturnBadRequest() {
                doThrow(new IllegalArgumentException("Width and Height are required for Poster displays"))
                                .when(validator).validate(any(MediaRequestModel.class));
                ...
                assertEquals(HttpStatus.BAD_REQUEST, exception.getStatusCode());
                assertEquals("Width and Height are required for Poster displays", exception.getReason());
        }

        @Test
        void updateMedia_NoMonthsSelected_ShouldReturnBadRequest() {
                doThrow(new IllegalArgumentException("At least one month must be selected"))
                                .when(validator).validate(any(MediaRequestModel.class));
                ...
                assertEquals(HttpStatus.BAD_REQUEST, exception.getStatusCode());
                assertEquals("At least one month must be selected", exception.getReason());
        }
