...
import { MediaModal } from "@/features/media-management/ui";
import { MediaTable } from "./MediaTable/MediaTable";
import { useMediaList, useMediaForm } from "@/features/media-management/model";
        ...
        <Group align="flex-start" gap={0} wrap="nowrap">
          {!isMobile && (
              <Paper w={250} p="md" style={{ minHeight: "calc(100vh - 80px)", borderRadius: 0 }} withBorder>
                <DashboardSidebar
                    roles={["mediaOwner", "businessOwner"]} // example: user has multiple roles
                    counters={{
                      adRequestsCount: media.length,
                      displayedAdsCount: 12,
                      transactionsCount: 4,
                      businessCount: 3,
                    }}
                />
